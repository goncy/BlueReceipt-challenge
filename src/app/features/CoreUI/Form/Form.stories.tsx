...
const ChallengeForm: FC<Props> = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit(mapSubmitHandler)}>
      <TwoColumnGrid>
        ...
        <Select
          ref={register({})}
          placeholder='Select multi features'
          name='multi'
          type='multi'
          options={['option 1', 'option 2']}
        />
        <Checkbox label='Pass challenge' name='challenge' ref={register({})} />
        <Button size='big' type='submit'>Submit</Button>
      </TwoColumnGrid>
    </form>
  );
...
export const challenge = () => (
  <ChallengeForm onSubmit={action('submit')} />
);
